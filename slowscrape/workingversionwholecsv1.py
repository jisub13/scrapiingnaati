...
translater_data = open("data/translator_data_{}.csv".format(todaydate), "w", newline='', encoding='utf-8')
interpreter_data = open("data/interpreter_data_{}.csv".format(todaydate), "w", newline='', encoding='utf-8')
deaf_interpreter_data = open("data/deafinterpreter_data_{}.csv".format(todaydate), "w", newline='', encoding='utf-8')
fields = ['Name', 'Language', 'Current Certifications', 'Location', 'Phone', 'Email', 'Website', 'Past Credentials']
translater_writer = csv.DictWriter(translater_data, fieldnames=fields)
int_writer = csv.DictWriter(interpreter_data, fieldnames=fields)
deaf_writer = csv.DictWriter(deaf_interpreter_data, fieldnames=fields)
# write headers
translater_writer.writeheader()
int_writer.writeheader()
deaf_writer.writeheader()
...
translater_data.close()
interpreter_data.close()
deaf_interpreter_data.close()
print("All done!")
